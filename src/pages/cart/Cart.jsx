        ...
        <div className="container flex1 ">
            <div className={styles.Cart + " focus "}>
                        ...
                        return <li key={i.id}>
                            <div className={styles.itemBlock}>
                                <div>
                                    ...
                                    <p>Preço final: {formattingPrice(calcPrecoItem(i))}</p>
                                </div>
                                <i className="fa-solid fa-xmark" onClick={() => removeFromCart(i)}></i>
                            </div>
                        </li>
                    })}
                    <hr />
                ...
                <div className={styles.totalBlock}>
                    <p>Preço total da compra: {formattingPrice(precoTotal)}</p>
